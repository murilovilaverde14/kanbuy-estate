  ...
  <div style={{display:'flex',alignItems:'center',gap:'1rem'}}>
    ...
    <nav style={{display:'flex',gap:'1.5rem',fontWeight:'600',color:'#003366'}}>
      ...
      <main style={fontFamily:'Inter,sans-serif',padding:'4rem 2rem'}>
        <h1 style={textAlign:'center',color:'#003366',marginBottom:'1rem'}>Owner Financing</h1>
        <p style={textAlign:'center',color:'#555',marginBottom:'2rem'}>
          Buy land directly from Kanbuy with zero banks or credit checks. Flexible monthly terms and fast approvals.
        </p>
