  ...
  return (
    <>
      ...
      <main style={{ fontFamily: 'Inter, sans-serif', padding: '4rem 2rem' }}>
        <h1 style={{ color: '#003366', textAlign: 'center', marginBottom: '1.5rem' }}>
          Financing Options
        </h1>
        <p
          style={{
        ...
        >
          We make land ownership easy with flexible monthly payment plans and
          zero credit checks. Explore our available financing options below.
        </p>
  ...
  return (
    <>
      ...
      <main style={{ fontFamily: 'Inter, sans-serif', padding: '4rem 2rem' }}>
        ...
        >
          We offer simple, affordable owner-financing options to make owning land easier.
        </p>
