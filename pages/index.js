  ...
  return (
    <>
      <Head>
        ...
        <meta name='description' content='Discover land for sale with flexible owner financing options.'/>
      </Head>
      <header style={{
    ...
    <nav style={{display:'flex',gap:'1.5rem',fontWeight:'600',color:'#003366'}}>
      ...
      <main style={fontFamily:'Inter, sans-serif',color:'#003366'}>
        ...
        <section style={{padding:'5rem 2rem',background:'#f7f9fb'}}>
          <h2 style={{textAlign:'center',fontSize:'2rem',marginBottom:'2rem'}}>Featured Land</h2>
          <div style={{
            ...
            {[
              ...
              <div key={{i}} style={{
                background:'#fff',borderRadius:'10px',boxShadow:'0 4px 10px rgba(0,0,0,0.08)',overflow:'hidden'
              }}>
                <img src={`https://images.unsplash.com/{img}?auto=format&fit=crop&w=800&q=60`} alt="Land"
                     style={{width:'100%',height:'220px',objectFit:'cover'}}/>
                <div style={padding:'1.5rem'}>
                  <h3>Lot {{i+1}} — Arkansas</h3>
                  <p>Starting at <strong>${{120+i*10}}/month</strong></p>
                  <a href={`/property/{i+1}`}>
                    <button style={{
