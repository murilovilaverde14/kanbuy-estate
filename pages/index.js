  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Discover affordable rural land with flexible owner financing."/>
      </Head>
      <header
  style={{
      ...
      <main style={fontFamily:'Inter,sans-serif',color:'#003366'}>
        <section style={
          ...
          <div style={position:'relative',zIndex:2}>
            ...
            <p style={maxWidth:'600px',margin:'0 auto 2rem',fontSize:'1.1rem'}>Explore beautiful rural properties across the U.S.</p>
            <a href="/properties">
              <button style={
            ...
            {[
              ...
              <div key={i} style={
                ...
                <div style={padding:'1.5rem'}>
                  ...
                  <p>Starting at <strong>${120+i*15}/month</strong></p>
                  <a href={`/property/{i+1}`}>
                    <button style={
